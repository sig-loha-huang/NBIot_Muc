...
#include <stdint.h>                           /* Include standard types */
  ...
  #define __NVIC_PRIO_BITS    5               /*!< standard definition for NVIC Priority Bits 通过往0xE000E400中写入0xff返回几个1即为优先级位数 */
#endif
...
/******  sig981 specific Interrupt Numbers *********************************************************/
  TIMER1_IRQn                   = 0,      /*!< Timer1 Interrupt                            */
...
static __INLINE void NVIC_PriorityGroupConfig(uint32_t NVIC_PriorityGroup)
{  
